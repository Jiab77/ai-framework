...
- **When I have doubts about a request**, I MUST read `HUMAN.md` first before asking or assuming.
- **If `HUMAN.md` does not exist or cannot be read**, I MUST stop immediately and ask the human — never guess, never assume.
